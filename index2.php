    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" href="../../index2.php" style="color: #659DBD;"><h1>Tenda Biru</h1></a>
          <a class="sidebar-brand brand-logo-mini" href="index2.php"><img src="assets/images/TendaBiru.png" alt="logo" /></a>
        </div>
        <ul class="nav">
